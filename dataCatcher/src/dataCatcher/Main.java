...
public class Main {
	...
	public static void main(String[] args) {
		...
		*/
		...
		Integer mois = aujourdHui.getMonthValue();
		Integer jour = aujourdHui.getDayOfMonth();
		String suffixe = jour + "_" + mois + ".csv";
		
		String nomFichierMorts = "morts_france_" + suffixe;
		String nomFichierCas = "cas_france_" + suffixe;
		
		ecrireFichier(nomFichierMorts, datesGoogle, datesSouhaitees, datesMortsManquantes);
		ecrireFichier(nomFichierCas, datesGoogleCas, datesSouhaitees, datesCasManquantes);
	}
